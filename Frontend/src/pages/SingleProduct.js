                  ...
                  <ul className="preview-thumbnail nav nav-tabs">
                    ...
                    <li>
                      {images.length > 0 ? (
                        ...
                        <img alt="product-img" src={`${images[0]?.url}`} />
                      )}
                    </li>
                    <li>
                      {images.length > 0 ? (
                        <a data-target="#pic-2" data-toggle="tab">
                          <img alt="product-img"
                            src={`${images[images.length > 2 ? 2 : 0]?.url}`}
                            onClick={(e) => {
                              e.preventDefault();
                    ...
                    <li>
                      {images.length > 0 ? (
                        <a data-target="#pic-2" data-toggle="tab">
                          <img alt="product-img"
                            src={`${images[images.length > 3 ? 3 : 0]?.url}`}
                            onClick={(e) => {
                              e.preventDefault();
...
align-items-center"
                  ...
                  <div className="action row d-flex  gap-30 justify-content-between mb-2">
    ...
    Buy Now
                  ...
                  <p className="vote">
                    <strong>{percentage ? percentage : ""}%</strong> of buyers
                    enjoyed this product!{" "}
                    <strong>({ratings ? ratings.length : ""} votes)</strong>
                  </p>
              ...
              <form action="" onSubmit={formik.handleSubmit}>
                ...
                <div className="row mb-2">
                  <CustomInput
                    ...
                    name="review"
                    rows={5}
                    onChng={formik.handleChange("review")}
