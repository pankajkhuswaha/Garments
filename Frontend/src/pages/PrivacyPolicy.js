        ...
        <div className="container-xxl">
          <div className="row d-flex align-items-center justify-content-center">
            <div className=" card rounded-5  col-sm-9  mx-auto  p-4 mx-5">
              ...
              <p>
                Our website address is: https://Manglagarments.online Powered
                by DRYISH ERCS
              </p>
              <h3>Comments</h3>
              <p>
              ...
              <p>
                ...
                available here: https://Manglagarments.online/privacy/. After
                approval of your comment, your profile picture is visible to the
