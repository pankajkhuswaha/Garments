...
export default function ResetPassword() {
  ...
  <>
    ...
    <div className="error text-danger text-danger text-danger text-danger text-danger text-danger text-danger">{formik.errors.password}</div>
  ) : null}
    ...
    <div className="error text-danger text-danger text-danger text-danger text-danger text-danger text-danger">{formik.errors.passwords}</div>
  ) : null}
